...
class ReportForm extends WoForm {
  ReportForm(BuildContext context, {super.key})
      : super(
          ...
          onSubmitting: (root, values) async {
            final json =
                await root.exportToMap(values: values, context: context);

            if (!context.mounted) {
              throw Exception("Context isn't mounted anymore");
            }
